    ...
    const steps: Step[] = [
        {
            ...
            iframeSrc: "https://player.cloudinary.com/embed/?cloud_name=ddmoxgaxf&public_id=configuration-data_kwuxaj&player[autoplay]=true&player[muted]=true&player[loop]=true"
        },
        {
            icon: Search,
