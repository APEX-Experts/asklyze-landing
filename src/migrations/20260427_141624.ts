...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "about_page_content_trusted_stats_locales" (
  	"value" varchar,
  	"label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "about_page_content_trusted_s_c1_stats_locales" (
  	"value" varchar,
  	"label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "about_page_content_solutions_what_we_build_points_locales" (
  	"text" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "about_page_content_guides_cards_locales" (
  	"title" varchar,
  	"description" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "about_page_content_leaders_members_locales" (
  	"name" varchar,
  	"role" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  DROP INDEX "about_page_content_trusted_stats_locale_idx";
  DROP INDEX "about_page_content_trusted_s_c1_stats_locale_idx";
  DROP INDEX "about_page_content_solutions_what_we_build_points_locale_idx";
  DROP INDEX "about_page_content_guides_cards_locale_idx";
  DROP INDEX "about_page_content_leaders_members_locale_idx";
  ...
  ALTER TABLE "about_page_content_trusted_stats_locales" ADD CONSTRAINT "about_page_content_trusted_stats_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about_page_content_trusted_stats"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about_page_content_trusted_s_c1_stats_locales" ADD CONSTRAINT "about_page_content_trusted_s_c1_stats_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about_page_content_trusted_s_c1_stats"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about_page_content_solutions_what_we_build_points_locales" ADD CONSTRAINT "about_page_content_solutions_what_we_build_points_locales_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about_page_content_solutions_what_we_build_points"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about_page_content_guides_cards_locales" ADD CONSTRAINT "about_page_content_guides_cards_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about_page_content_guides_cards"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about_page_content_leaders_members_locales" ADD CONSTRAINT "about_page_content_leaders_members_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about_page_content_leaders_members"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "about_page_content_trusted_stats_locales_locale_parent_id_un" ON "about_page_content_trusted_stats_locales" USING btree ("_locale","_parent_id");
  CREATE UNIQUE INDEX "about_page_content_trusted_s_c1_stats_locales_locale_parent_" ON "about_page_content_trusted_s_c1_stats_locales" USING btree ("_locale","_parent_id");
  CREATE UNIQUE INDEX "about_page_content_solutions_what_we_build_points_locales_lo" ON "about_page_content_solutions_what_we_build_points_locales" USING btree ("_locale","_parent_id");
  CREATE UNIQUE INDEX "about_page_content_guides_cards_locales_locale_parent_id_uni" ON "about_page_content_guides_cards_locales" USING btree ("_locale","_parent_id");
  CREATE UNIQUE INDEX "about_page_content_leaders_members_locales_locale_parent_id_" ON "about_page_content_leaders_members_locales" USING btree ("_locale","_parent_id");
  ...
  ALTER TABLE "about_page_content_trusted_stats" DROP COLUMN "_locale";
  ALTER TABLE "about_page_content_trusted_stats" DROP COLUMN "value";
  ALTER TABLE "about_page_content_trusted_stats" DROP COLUMN "label";
  ALTER TABLE "about_page_content_trusted_s_c1_stats" DROP COLUMN "_locale";
  ALTER TABLE "about_page_content_trusted_s_c1_stats" DROP COLUMN "value";
  ALTER TABLE "about_page_content_trusted_s_c1_stats" DROP COLUMN "label";
  ALTER TABLE "about_page_content_solutions_what_we_build_points" DROP COLUMN "_locale";
  ALTER TABLE "about_page_content_solutions_what_we_build_points" DROP COLUMN "text";
  ALTER TABLE "about_page_content_guides_cards" DROP COLUMN "_locale";
  ALTER TABLE "about_page_content_guides_cards" DROP COLUMN "title";
  ALTER TABLE "about_page_content_guides_cards" DROP COLUMN "description";
  ALTER TABLE "about_page_content_leaders_members" DROP COLUMN "_locale";
  ALTER TABLE "about_page_content_leaders_members" DROP COLUMN "name";
  ALTER TABLE "about_page_content_leaders_members" DROP COLUMN "role";`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "about_page_content_trusted_stats_locales" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "about_page_content_trusted_s_c1_stats_locales" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "about_page_content_solutions_what_we_build_points_locales" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "about_page_content_guides_cards_locales" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "about_page_content_leaders_members_locales" DISABLE ROW LEVEL SECURITY;
  ...
  DROP TABLE "about_page_content_trusted_stats_locales" CASCADE;
  DROP TABLE "about_page_content_trusted_s_c1_stats_locales" CASCADE;
  DROP TABLE "about_page_content_solutions_what_we_build_points_locales" CASCADE;
  DROP TABLE "about_page_content_guides_cards_locales" CASCADE;
  DROP TABLE "about_page_content_leaders_members_locales" CASCADE;
  ...
  ALTER TABLE "about_page_content_trusted_stats" ADD COLUMN "_locale" "_locales" NOT NULL;
  ALTER TABLE "about_page_content_trusted_stats" ADD COLUMN "value" varchar;
  ALTER TABLE "about_page_content_trusted_stats" ADD COLUMN "label" varchar;
  ALTER TABLE "about_page_content_trusted_s_c1_stats" ADD COLUMN "_locale" "_locales" NOT NULL;
  ALTER TABLE "about_page_content_trusted_s_c1_stats" ADD COLUMN "value" varchar;
  ALTER TABLE "about_page_content_trusted_s_c1_stats" ADD COLUMN "label" varchar;
  ALTER TABLE "about_page_content_solutions_what_we_build_points" ADD COLUMN "_locale" "_locales" NOT NULL;
  ALTER TABLE "about_page_content_solutions_what_we_build_points" ADD COLUMN "text" varchar;
  ALTER TABLE "about_page_content_guides_cards" ADD COLUMN "_locale" "_locales" NOT NULL;
  ALTER TABLE "about_page_content_guides_cards" ADD COLUMN "title" varchar;
  ALTER TABLE "about_page_content_guides_cards" ADD COLUMN "description" varchar;
  ALTER TABLE "about_page_content_leaders_members" ADD COLUMN "_locale" "_locales" NOT NULL;
  ALTER TABLE "about_page_content_leaders_members" ADD COLUMN "name" varchar;
  ALTER TABLE "about_page_content_leaders_members" ADD COLUMN "role" varchar;
