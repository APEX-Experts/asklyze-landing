...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_posts_category" AS ENUM('Tutorial', 'Industry Trends', 'Features', 'Security', 'Case Study', 'Product Update');
  ...
  CREATE TABLE "posts" (
  	...
  	"author_job_title" varchar,
  	"author_job_title_ar" varchar,
