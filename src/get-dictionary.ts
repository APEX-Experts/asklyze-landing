...
const fetchDictionary = async (locale: "en" | "ar"): Promise<Dictionary> => {
  try {
    ...
    const [
      ...
      payload.findGlobal({ slug: "navbar-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "hero-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "working-process-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "trusted-by-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "why-choose-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "contact-hero-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "feature-grid-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "common-cta-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "contact-cta-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "faq-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "pricing-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "contact-us-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "footer-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "blog-section-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "blog-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "metadata-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "privacy-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "terms-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "security-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "about-page-content", locale, depth: 5 }),
      payload.findGlobal({ slug: "site-settings", locale, depth: 5 }),
    ]);
