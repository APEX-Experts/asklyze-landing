...
export default async function BlogPostPage({
  ...
  return (
    <main className="min-h-screen bg-[#0f0f18]">
      ...
      <div className="absolute top-0 right-0 w-1/3 h-[800px] bg-linear-to-l from-[#ff705a]/5 to-transparent opacity-60 -z-10" />
          ...
          <div className="flex items-center justify-center gap-4 py-8 border-y border-white/5">
            ...
            <div className="text-left">
              ...
              <div className="flex items-center gap-2 mt-1">
                {authorJobTitle && (
                  <span className="text-[#ff705a] text-xs font-semibold">
                    {authorJobTitle}
                  </span>
                )}
      ...
      {heroImage && (
        <section className="pb-16 px-4">
          <div className="max-w-5xl mx-auto">
            <div className="relative w-full aspect-video rounded-[32px] overflow-hidden shadow-2xl border border-white/10">
              <Image
                src={heroImage}
                alt={displayTitle}
                fill
